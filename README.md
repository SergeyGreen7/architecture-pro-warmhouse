...
![er.png](docs/architecure/er/er.png)

# Задание 4. Создание и документирование API

### 1. Тип API

Для взаимодействия микросервисов используется синхронный REST API поверх HTTP с обменом данными в формате JSON.
Этот подход прост в реализации и отладке, поддерживается всеми сервисами и хорошо подходит для текущих операций получения телеметрии и управления устройствами.

### 2. Документация API

[telemetry-service swagger](apps\telemetry_service\openapi.yaml)

[device-service swagger](apps/device_service/openapi.yaml)
